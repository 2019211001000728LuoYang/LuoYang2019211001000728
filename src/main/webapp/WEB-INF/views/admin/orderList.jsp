		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.LuoYang.model.Order o=(com.LuoYang.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.LuoYang.dao.UserDao userDao=new com.LuoYang.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.LuoYang.model.Payment.findByPaymentId(con,n);
						%>
